...
url_zip: assets/imgs/WP05/P0012/WKB_expansion.zip
---
...
![]({{site.url}}/{{site.baseurl}}/assets/imgs/WP05/P0012/copiaRM_01.png)
...
![]({{site.url}}/{{site.baseurl}}/assets/imgs/WP05/P0012/copiaRM_02.png)

By typing "animation(x,t,u)" in the MATLAB console you can see the evolution in time of this wave.


![$$u(t)$$ function]({{site.url}}/{{site.baseurl}}/assets/imgs/WP05/P0012/wave.gif)
